...
<div class="row" style="padding-left: 20px;">
    <div class="panel panel-default col-lg-8">
        <table class="table table-striped table-bordered table-hover" id="dataTables-example" >
            <thead><tr><th>Survey Name</th><th>Field User Name</th><th>Survey Completed</th><th>Survey Audited</th><th>Audited By</th><td>  <button type="button" class="btn" data-toggle="collapse" data-target=".collapseme">
...
<div class="row col-lg-12" id="example2" style="padding-left: 20px;padding-top: 5px;">
    <table class="table table-striped table-bordered table-hover" >
        <thead><tr><th> Survey name saved by user</th><th>Upload Date</th><th>Audited</th><th>Audit Date</th><th>Match (%)</th><th>Comment</th><th>Action</th></tr></thead>
        <tbody id="tbody2">
        ...
        $(".clickable").on('click', function () {
            $.getJSON(website + "UIAPI/get_audited_entries/" + $(this).attr("userid") + "/" + $(this).attr("surveyid"), function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    var obj = data[i];
//                    console.log(obj[0]);
                    $("#tbody2").append("<tr><td>" + obj[0].name + "</td><td>" + obj[0].time + "</td><td>" + "</td><td>" + obj.UserQuestionData.is_audit_done + "</td><td>" +
